...
func Board(boardConfig config.BoardUIConfig) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"grid h-full w-full grid-rows-[48px_1fr]\"><!-- Header with loot inventory --><header class=\"flex items-center justify-between border-b border-border bg-card/80 px-3 backdrop-blur\"><div class=\"flex items-center gap-3\"><!-- Mobile hamburger menu --><button id=\"goalsMenuToggle\" class=\"rounded-md border border-border bg-card px-2 py-1.5 hover:bg-accent md:hidden\" type=\"button\" aria-label=\"Toggle goals menu\"><svg class=\"h-4 w-4\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M4 6h16M4 12h16M4 18h16\"></path></svg></button><div class=\"text-sm font-bold tracking-wide\">DONEGEON</div></div><!-- Loot inventory --><div id=\"lootInventory\" class=\"flex items-center gap-3 text-sm\"><div class=\"flex items-center gap-1\" title=\"Coins\"><span>🪙</span> <span id=\"loot-coin\" class=\"font-semibold\">0</span></div><div class=\"flex items-center gap-1\" title=\"Paper\"><span>📄</span> <span id=\"loot-paper\" class=\"font-semibold\">0</span></div><div class=\"flex items-center gap-1\" title=\"Ink\"><span>🖋️</span> <span id=\"loot-ink\" class=\"font-semibold\">0</span></div><div class=\"flex items-center gap-1\" title=\"Gear\"><span>⚙️</span> <span id=\"loot-gear\" class=\"font-semibold\">0</span></div><div class=\"flex items-center gap-1\" title=\"Parts\"><span>🔩</span> <span id=\"loot-parts\" class=\"font-semibold\">0</span></div><div class=\"flex items-center gap-1\" title=\"Blueprint Shards\"><span>🧩</span> <span id=\"loot-blueprint_shard\" class=\"font-semibold\">0</span></div></div><!-- Action buttons --><div class=\"flex items-center gap-2\"><button id=\"endDayBtn\" type=\"button\" class=\"rounded-md border border-red-500/50 bg-red-500/10 px-3 py-1 text-xs font-medium text-red-400 hover:bg-red-500/20\">End Day</button> <button id=\"boardRefreshBtn\" type=\"button\" class=\"rounded-md border border-border bg-card px-3 py-1 text-xs hover:bg-accent\">Refresh</button> <button type=\"button\" class=\"rounded-md border border-border bg-card px-2 py-1 text-xs hover:bg-accent\">?</button></div></header><div id=\"appShell\" class=\"flex h-full w-full min-w-0 overflow-hidden\"><!-- Today's Goals sidebar (desktop only - hidden on mobile) --><aside id=\"goalsSidebarDesktop\" class=\"w-[280px] shrink-0 h-full border-r border-border bg-zinc-900/95 overflow-y-auto max-md:hidden\">")
		if templ_7745c5c3_Err != nil {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/board.templ`, Line: 102, Col: 75}
		}
